 ...
 *	@category		Library
 *	@package		CeusMedia_NetServices
 *	@implements		\CeusMedia\NetService\Interface\Point
 *	@uses			\CeusMedia\NetService\Parameter\Validator
 *	@uses			\CeusMedia\NetService\Parameter\Filter
 *	@uses			\CeusMedia\NetService\Definition\Loader
 *	@author			Christian Würker <christian.wuerker@ceusmedia.de>
 *	@copyright		2007-2015 Christian Würker
 *	@license		http://www.gnu.org/licenses/gpl-3.0.txt GPL 3
 *	@link			https://github.com/CeusMedia/NetServices
 ...
 */
class Point implements \CeusMedia\NetServices\PointInterface{

	/**	@var		string			$defaultLoader		Default Definition Loader Class */
	protected $defaultLoader		= "\\CeusMedia\\NetServices\\Definition\\Loader";
	/**	@var		string			$defaultValidator	Default Validator Class */
	protected $defaultFilter		= "\\CeusMedia\\NetServices\\Paramete\\Filter";
	/**	@var		string			$defaultValidator	Default Validator Class */
	protected $defaultValidator		= "\\CeusMedia\\NetServices\\Parameter\\Validator";
	/**	@var		string			$validatorClass		Definition Loader Class to use */
	public static $loaderClass		= "\\CeusMedia\\NetServices\\Definition\\Loader";
	/**	@var		string			$filterClass		Filter Class to use */
	public static $filterClass		= "\\CeusMedia\\NetServices\\Parameter\\Filter";
	/**	@var		string			$validatorClass		Validator Class to use */
	public static $validatorClass	= "\\CeusMedia\\NetServices\\Parameter\\Validator";
	...
	protected function checkServiceParameters( $serviceName, $parameters ){
		...
		foreach( $this->services['services'][$serviceName]['parameters'] as $name => $rules ){
			...
			try{
				...
				throw new \CeusMedia\NetService\Parameter\Exception( $message );
			}
		}
	}
